...
<body>
    ...
    <header><a href="front-end/about.html"><img id="logo" src="img/logo.svg"></a>
        <div class="user">
    ...
    <ul class="menu">
        ...
        <li><a href="front-end/about.html"><img src="img/info_yellow.png"><p class="left-margin">About</p></a></li>
